...
ActiveRecord::Schema[8.1].define(version: 2026_04_26_190239) do
  ...
  create_table "activity_logs", force: :cascade do |t|
    ...
    t.index ["event_id"], name: "index_activity_logs_on_event_id"
    t.index ["oshi_id"], name: "index_activity_logs_on_oshi_id"
  ...
  add_foreign_key "activity_logs", "events"
  add_foreign_key "activity_logs", "oshis"
